...
read_verilog -sv "example_soc/soc/example_soc.v"
...
#ddr3
read_verilog -sv "example_soc/libfpga/mem//ddr3/clk_wiz.v "
read_verilog -sv "example_soc/libfpga/mem//ddr3/ddr3_controller.v"
read_verilog -sv "example_soc/libfpga/mem//ddr3/ddr3_phy.v"
read_verilog -sv "example_soc/libfpga/mem//ddr3/ddr3_top.v" 
read_verilog -sv "example_soc/libfpga/mem//ddr3/memory.v"
read_verilog -sv "example_soc/libfpga/mem//ddr3/wukong_ddr3.v"
...
#read_verilog -sv "example_soc/libfpga/mem/sdram-qm/memsim.v"
...
# synth
set_param synth.elaboration.rodinMoreOptions {rt::set_parameter dissolveMemorySizeLimit 4194304}
