...
// 8K Refresh Cycles/64 mS -> 1 refresh / 800 periods.
`define maxrefreshcnt 32'b1111_0000
	...
	if( !rst )
		...
		begin
			...
			case( state_cnt )
				...
				'd53: read   (naddr[23:22], naddr[8:0], hi_z, 0/*ndqmi*/);          //53 Read
				...
				'd57: urddata1 <= data; // 6 other words arrive after urddata1 too
				//'d58: state_cnt <= 'd67;
